...
extern EIF_TYPED_VALUE F596_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F596_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 595, Current, 0, 0, 3232);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(595, Current, 3232);
	RTIV(Current, RTAL);
