...
extern EIF_TYPED_VALUE F728_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F728_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 727, Current, 0, 0, 3234);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(727, Current, 3234);
	RTIV(Current, RTAL);
