...
{
	GTCX
	RTOTC (F29_683,762,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {378,0xFF01,259,0xFFFF};
		EIF_TYPE typres0;
...
{
	GTCX
	RTOTC (F29_688,767,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
{
	GTCX
	RTOTC (F29_689,768,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
{
	GTCX
	RTOTC (F29_690,769,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
