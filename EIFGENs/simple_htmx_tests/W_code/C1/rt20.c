...
extern void F20_380(EIF_REFERENCE);
extern EIF_TYPED_VALUE F20_381(EIF_REFERENCE);
...
extern void F20_385(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F20_380 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 380, 0x10000000, 1); /* maximum_record_count */
	*(EIF_INTEGER_32 *)(Current + RTWA(380, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 1000000L);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 381, 0x04000000, 1); /* flatten_when_closing */
	*(EIF_BOOLEAN *)(Current + RTWA(381, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 382, 0x04000000, 1); /* keep_calls_records */
	*(EIF_BOOLEAN *)(Current + RTWA(382, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 383, 0x04000000, 1); /* recording_values */
	*(EIF_BOOLEAN *)(Current + RTWA(383, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
EIF_TYPED_VALUE F20_381 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(380,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F20_383 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(382,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F20_384 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(383,Dtype(Current)));
	return r;
}


/* {RT_DBG_EXECUTION_PARAMETERS}.set_maximum_record_count */
void F20_385 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 19, Current, 0, 1, 385);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 380, 0x10000000, 1); /* maximum_record_count */
	*(EIF_INTEGER_32 *)(Current + RTWA(380, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 19, Current, 0, 1, 386);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 19, Current, 0, 1, 387);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 382, 0x04000000, 1); /* keep_calls_records */
	*(EIF_BOOLEAN *)(Current + RTWA(382, dtype)) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 19, Current, 0, 1, 388);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 383, 0x04000000, 1); /* recording_values */
	*(EIF_BOOLEAN *)(Current + RTWA(383, dtype)) = (EIF_BOOLEAN) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
