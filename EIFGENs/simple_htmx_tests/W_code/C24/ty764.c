...
extern EIF_TYPED_VALUE F764_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F764_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 763, Current, 0, 0, 3235);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(763, Current, 3235);
	RTIV(Current, RTAL);
