...
extern EIF_TYPED_VALUE F110_1498(EIF_REFERENCE);
extern EIF_TYPED_VALUE F110_1499(EIF_REFERENCE);
...
EIF_TYPED_VALUE F110_1498 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1519);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(1488, 131))(Current)).it_i4);
...
RTOID (F110_1499)
EIF_TYPED_VALUE F110_1499 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 109, Current, 0, 0, 1520);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
