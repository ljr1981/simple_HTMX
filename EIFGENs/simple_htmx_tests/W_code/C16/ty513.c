...
extern EIF_TYPED_VALUE F513_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F513_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 512, Current, 0, 0, 3229);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(512, Current, 3229);
	RTIV(Current, RTAL);
