...
extern EIF_TYPED_VALUE F66_1199(EIF_REFERENCE);
...
EIF_TYPED_VALUE F66_1199 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 65, Current, 0, 0, 1231);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(65, Current, 1231);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80003F1, 0,0); /* Result */
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF01,1009,0xFF01,0,0xFFFF};
		EIF_TYPE typres0;
