...
extern EIF_TYPED_VALUE F454_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F454_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 453, Current, 0, 0, 3228);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(453, Current, 3228);
	RTIV(Current, RTAL);
