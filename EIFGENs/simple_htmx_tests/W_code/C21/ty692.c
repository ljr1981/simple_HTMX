...
extern EIF_TYPED_VALUE F692_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F692_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 691, Current, 0, 0, 3233);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(691, Current, 3233);
	RTIV(Current, RTAL);
