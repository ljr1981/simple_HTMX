...
extern EIF_TYPED_VALUE F633_3345(EIF_REFERENCE);
...
EIF_TYPED_VALUE F633_3345 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 632, Current, 0, 0, 4606);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(632, Current, 4606);
	RTIV(Current, RTAL);
	RTHOOK(1);
