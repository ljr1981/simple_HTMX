...
extern EIF_TYPED_VALUE F908_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F908_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 907, Current, 0, 0, 3239);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(907, Current, 3239);
	RTIV(Current, RTAL);
