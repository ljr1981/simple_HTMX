...
extern EIF_TYPED_VALUE F944_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F944_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 3240);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 3240);
	RTIV(Current, RTAL);
