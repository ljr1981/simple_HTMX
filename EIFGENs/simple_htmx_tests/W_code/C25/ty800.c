...
extern EIF_TYPED_VALUE F800_3188(EIF_REFERENCE);
...
EIF_TYPED_VALUE F800_3188 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 799, Current, 0, 0, 3236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(799, Current, 3236);
	RTIV(Current, RTAL);
